...
// Apenas funcionários podem acessar esta página
if ($_SESSION['user_type'] !== 'admin') {
    header("Location: ../index.php");
    exit();
}

// Buscar produtos da categoria 'papelaria'
$query = "SELECT id, nome, preco, stock, imagem FROM produtos WHERE categoria = 'papelaria' ORDER BY nome ASC";
$result = $conn->query($query);

$pageTitle = "Gestão da Papelaria";
...
<div class="container mt-5">
    <div class="text-center">
        <h1 class="fw-bold titulo-sombreado">
            <i class="bi bi-pencil"></i> Gestão da Papelaria
        </h1>
        <p class="text-muted">Faça a gestão dos produtos disponíveis na papelaria.</p>
    </div>
